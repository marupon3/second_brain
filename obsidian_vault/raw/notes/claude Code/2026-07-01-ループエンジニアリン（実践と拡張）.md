...
tags:
  ...
  - loop
---
![[Pasted image 20260823092312.png]]
# 要約

多くの人はAIを従来の検索のように手動で使っているが、真の生産性向上は「ループ」の構築にあると主張。
KarpathyのAutoResearchを例に、検証器・状態・停止条件を備えた自律ループの仕組みを解説し、さらにその上にメタループを重ねるBilevel手法で5倍の改善が可能だと示す。
ただし理解不足や思考放棄のリスクも指摘する。
