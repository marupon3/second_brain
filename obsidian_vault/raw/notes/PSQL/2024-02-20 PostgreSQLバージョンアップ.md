...
psqlODBC(64bit)　v13ドライバ  インストールせず(v16.0.0.5を別途インストール）
psqlSQL(64bit)  v16.3-2
pgAgent(64bit)  v4.2.2  インストールせず(v4.8.9を別途インストール）
![](file5815.files/image001.png)
...
![](file5815.files/image002.png)
Windowsの検索ボックスに「odbc」と入力
「ODBC データソース(64
ビット)」をクリック
![](file5815.files/image003.png)
'VBAの例
